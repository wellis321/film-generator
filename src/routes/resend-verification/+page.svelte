...
<svelte:head>
	<title>Resend confirmation — Regretometer</title>
</svelte:head>

<div class="mx-auto max-w-sm">
	<h1 class="text-3xl font-black text-neutral-50">Resend confirmation email</h1>
	<p class="mt-2 text-neutral-400">Enter your email and we'll send the link again.</p>
	...
	{:else}
		...
		>
			...
			<button
				type="submit"
				class="w-full rounded-full bg-amber-400 px-5 py-2.5 text-sm font-semibold text-neutral-950 transition hover:bg-amber-300"
			>
				Resend link
			</button>
		</form>
	...
	<p class="mt-4 text-sm text-neutral-500">
		<a href="/login" class="text-amber-400 hover:underline">Back to log in</a>
	</p>
</div>
